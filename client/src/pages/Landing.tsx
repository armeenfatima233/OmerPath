...
function Hero() {
  return <section id="top" className="landing-hero"><div className="landing-hero-image"/><div className="landing-hero-overlay"/><LandingNav/><div className="landing-hero-content landing-reveal"><div className="landing-kicker light-kicker"><span/> Global education, clearly guided</div><h1>Your global education <em>starts here.</em></h1><p>See scholarships matched to your profile, understand why they fit, and manage every step through to submission.</p><div className="landing-hero-actions"><Link href="/signup" className="landing-primary focus-ring">Find my scholarships <ArrowRight size={17}/></Link><a href="#quick-match" className="landing-secondary focus-ring">Try the matcher <span>↓</span></a></div><div className="landing-hero-note"><span className="landing-note-line"/> Based on your profile. Never a promise of outcome.</div></div><div className="landing-hero-caption">Education is a route, not a single destination <span>OmerPath / 01</span></div></section>;
}
...
function FinalCTA() {
  return <section className="landing-final landing-reveal"><div className="landing-final-image"/><div className="landing-final-overlay"/><div className="landing-final-content"><div className="landing-kicker light-kicker">Your next chapter is somewhere out there</div><h2>Your next opportunity could be <em>closer than you think.</em></h2><p>Create your profile and see OmerPath in action, from matching to application planning.</p><Link href="/signup" className="landing-primary focus-ring">Create my profile <ArrowRight size={17}/></Link></div><div className="landing-final-footer"><span>OmerPath</span><span>Scholarship search, with a clearer path.</span><span>© 2026</span></div></section>;
}
